function Quote() {
  return (
    <div className='h-full flex items-center justify-center p-4 bg-app-green'>
      <div className="max-w-2xl bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-xl p-8 shadow-lg ">
